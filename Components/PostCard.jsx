...
const PostCard = ({post}) => {
  return (
    <div className='bg-white shadow-lg rounded-lg p-0 lg:pt-10 pb-12 mb-8'>
      ...
      <div style={{height: '515px'}}  className='relative overflow-hidden shadow-md mb-6' >
        <img 
          src={post.featuredImage.url} 
          alt={post.title}
          className='object-top absolute object-cover w-full shadow-lg rounded-t-lg lg:rounded-lg'
        />
      </div>
